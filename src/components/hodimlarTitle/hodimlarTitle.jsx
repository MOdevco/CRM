...
const HodimlarTitle = ({handlesearch,query,setQuery}) => {
          ...
          >
            ...
            >
              ...
              onChange={(e) => handlesearch(e)}
                ...
                type="text"
                className="inp"
                placeholder="Hodimlar bo’yicha qidirish..."
            ...
            <Box>
              ...
              <Modal onClose={onClose} isOpen={isOpen} isCentered>
                <ModalOverlay />
                <ModalContent>
                  <ModalHeader borderBottom={"8px"} borderColor={"gray"}>
                  ...
                  >
                    <FormControl>
                      ...
                      <Select
                        onChange={(e) =>
                          setDataValue({ ...dataValue, fid: e.target.value })
                        }
                      >
                        <option selected disabled className="option" value="">
                          Jismoniy shahslar
                        </option>
                        {data.map((item, i) => (
                    ...
                    <FormControl>
                      ...
                      <Select
                        onChange={(e) =>
                          setDataValue({ ...dataValue, cid: e.target.value })
                        }
                      >
                        <option
                          style={{ color: "gray" }}
                  ...
                  <ModalFooter display={"flex"} gap={"20px"}>
                    <Button bg={"#DBDBDB"} onClick={onClose}>
                      Bekor qilish
                    </Button>
                    <Button
